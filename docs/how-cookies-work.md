...
That last point is why Safari Cookie Cleaner focuses only on cookies: they are the most common and most targeted identifier store, but they are not the only one.
